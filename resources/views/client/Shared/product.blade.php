            ...
            <div class="col-12">
                <div class="popular-products-slides owl-carousel">
                    ...
                    <div class="single-product-wrapper border p-2 rounded ">
                        <a href="">
                        <div class="product-img">
                            <img src="" style="object-fit: cover; width:300px; height:300px" alt="">
                            <img class="hover-img" src="" style="object-fit: cover; width:300px; height:300px" alt="">
                            <div class="product-favourite">
                                <a href="#" class="fas fa-shopping-bag"></a>
                            </div>
                        </div>
                        <div class="product-description">
                            <span></span>
                                <h6></h6>
                            <p style="font-size: 20px;" class="product-price">/chai</p>
                            <div class="hover-content">
                            </div>
                        </div>
                        </a>
